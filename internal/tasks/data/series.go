...
func SeriesTasks() *[]tasksModels.Task {
	return &[]tasksModels.Task{
		{
			...
			Answer: func (args ...int) int {
				...
				return tasksHelpers.IntPow(2, a) + b * tasksHelpers.IntPow(2, b - 1) + tasksHelpers.Binomial(2 * c, c)
			},
		},
		{
			Difficulty: 1,
		...
		},
		{
			...
			Answer: func (args ...int) int {
				...
				if k % 2 == 0 {
					...
					return tasksHelpers.IntPow(-1, half) * tasksHelpers.Binomial(n, half)
				}
		...
		},
		{
			...
			Math: func (args ...int) string {
				k := args[0]
				l := args[1]
				a := tasksHelpers.IntPow(2, k)
				b := a + tasksHelpers.IntPow(2, l)
		...
		},
		{
			...
			Answer: func (args ...int) int {
				...
				return tasksHelpers.IntPow(q, p - 1)
			},
		},
	}
}
